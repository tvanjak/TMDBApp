...
//        self.mediaRepo = mediaRepo
    ...
    func loadPopularMovies() async {
        do {
            let dtoData = try await MediaRepository.shared.fetchPopularMovies()
    ...
    func loadTrendingMovies() async {
        do {
            let dtoData = try await MediaRepository.shared.fetchTrendingMovies()
    ...
    func loadUpcomingMovies() async {
        do {
            let dtoData = try await MediaRepository.shared.fetchUpcomingMovies()
    ...
    func loadNowPlayingMovies() async {
        do {
            let dtoData = try await MediaRepository.shared.fetchNowPlayingMovies()
    ...
    func loadPopularTVShows() async {
        do {
            let dtoData = try await MediaRepository.shared.fetchPopularTVShows()
    ...
    func loadTopRatedTVShows() async {
        do {
            let dtoData = try await MediaRepository.shared.fetchTopRatedTVShows()
    ...
    func search() async {
        do {
            let dtoData1 = try await MediaRepository.shared.fetchSearchedMovies(query: searchTerm)
            searchedMovies = dtoData1.map(MediaItemViewModel.init)
            
            let dtoData2 = try await MediaRepository.shared.fetchSearchedTVShows(query: searchTerm)
